...
const UserController = {
  ...
  async createUser (req, res) {
    ...
    try {
      const { first_name, last_name, email, hash_password, username } = req.body;
      ...
      const updatedUser = await UserModels.updateUser(req.params.id,first_name, last_name, email, hash_password, username);
      if (updatedUser) {
