...
async function migrateAll() {
  try {
    ...
    console.log('Todas as tabelas foram criadas com sucesso no ambiente de desenvolvimento.');
  } catch (err) {
    console.error('Erro ao executar as migrações no ambiente de desenvolvimento:', err.message);
  }
}
