...
async function migrate() {
  ...
  try {
    ...
    console.log('Tabela "module" criada com sucesso no ambiente de desenvolvimento.');
  } catch (err) {
    await pool.query('ROLLBACK;');
    console.error('Erro ao criar a tabela "module" no ambiente de desenvolvimento:', err.message);
    throw err;
  }
}
